...
public class PartnerReceiver extends BroadcastReceiver {
    ...
    private static final String SHIELDHUB_PKG_NAME = "com.nvidia.tegrazone3";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_PACKAGE_ADDED.equals(action)||
            ...
            //postNotification(SHIELDHUB_PKG_NAME);
        }
    }
    ...
    private void postNotification(String pkgName) {
        ...
        switch (pkgName) {
            case SHIELDHUB_PKG_NAME:
                sort = 1;
                //resId = R.drawable.ic_shieldhub_banner;
                //backupResId = R.drawable.ic_shieldhub_banner;
                resId = 0;
                backupResId = 0;
                titleId = R.string.shieldhub;
                backupTitleId = R.string.shieldhub;
                break;
            default:
                return;
        }
